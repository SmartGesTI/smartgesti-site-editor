  ...
  structure: [
    ...
    // ============================================
    {
      ...
      props: {
        ...
        logo: { src: "/logo.svg", alt: "Colégio Vanguarda", href: "/" },
        logoText: "Colégio Vanguarda",
        links: [
          { text: "Início", href: "/" },
          { text: "Nossa História", href: "/site/p/sobre" },
          { text: "Ensino", href: "/site/p/cursos" },
          { text: "Estrutura", href: "/site/p/infraestrutura" },
          { text: "Blog", href: "/site/p/blog" },
          { text: "Contato", href: "/site/p/contato" },
        ],
        ctaButton: { text: "Agende uma Visita", href: "/site/p/matricula" },
        sticky: true,
        transparent: true,
