...
export interface StackBlock extends BlockBase {
  type: 'stack'
  props: { direction?: 'row' | 'col'; gap?: string; align?: string; justify?: string; wrap?: boolean; children?: Block[] }
}

export interface GridBlock extends BlockBase {
  type: 'grid'
  props: { cols?: number | { sm?: number; md?: number; lg?: number }; gap?: string; children?: Block[] }
}

export interface BoxBlock extends BlockBase {
  type: 'box'
  props: { bg?: string; border?: string; radius?: string; shadow?: string; padding?: string; children?: Block[] }
}
...
export interface HeadingBlock extends BlockBase {
  type: 'heading'
  props: { level: 1 | 2 | 3 | 4 | 5 | 6; text: string; align?: string; color?: string }
}

export interface TextBlock extends BlockBase {
  type: 'text'
  props: { text: string; align?: string; color?: string; size?: 'sm' | 'md' | 'lg' }
}

export interface ImageBlock extends BlockBase {
  type: 'image'
  props: { src: string; alt?: string; width?: string; height?: string; objectFit?: string }
}

export interface ButtonBlock extends BlockBase {
  type: 'button'
  props: { text: string; href?: string; variant?: 'primary' | 'secondary' | 'outline' | 'ghost'; size?: 'sm' | 'md' | 'lg' }
}
...
export interface VideoBlock extends BlockBase {
  type: 'video'
  props: { src: string; poster?: string; autoplay?: boolean; loop?: boolean; muted?: boolean }
}
...
export interface CtaBlock extends BlockBase {
  type: 'cta'
  props: { title: string; description?: string; buttonText: string; buttonHref?: string; variant?: 'simple' | 'centered' | 'split' }
}
...
export interface StatsBlock extends BlockBase {
  type: 'stats'
  props: { items: Array<{ value: string; label: string; description?: string }> }
}
...
export interface InputBlock extends BlockBase {
  type: 'input'
  props: { name: string; type?: string; label?: string; placeholder?: string; required?: boolean }
}

export interface TextareaBlock extends BlockBase {
  type: 'textarea'
  props: { name: string; label?: string; placeholder?: string; rows?: number; required?: boolean }
}

export interface FormSelectBlock extends BlockBase {
  type: 'formSelect'
  props: { name: string; label?: string; options: Array<{ value: string; label: string }>; required?: boolean }
}
