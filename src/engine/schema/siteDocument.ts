...
export interface SocialLinksBlock extends BlockBase {
  ...
  props: {
    links: Array<{
      platform: 'facebook' | 'twitter' | 'instagram' | 'linkedin' | 'youtube' | 'tiktok' | 'github' | 'whatsapp'
      url: string
    }>
    size?: 'sm' | 'md' | 'lg'
 ...
 */
export function createEmptySiteDocumentV2(_name: string = 'Novo Site'): SiteDocumentV2 {
  return {
    schemaVersion: 2,
    theme: {
      colors: {
